...
const std::string MODEL_PATH = "models/Handgun_obj.obj";
const std::string TEXTURE_PATH = "textures/handgun_C.jpg";
...
// DESCRIPTOR SETS -> D LAYOUT -> D SAMPLER -> imge view -> buffer
